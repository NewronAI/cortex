...
const routes = createHashRouter([
  ...
  { path: '/crawl', element: <CrawlingStatusPage /> },
  {
    ...
    element: (
      <LinksPage
        title="Found Links"
        desc="These are the links found by the crawler. This list updates as the crawler finds more links."
      />
    ),
  },
...
function App() {
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-white">
      <TitleBar />
      <div className="flex-1 relative isolate overflow-hidden p-2">
